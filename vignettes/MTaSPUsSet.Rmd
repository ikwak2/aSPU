...
```
`MTaSPUsSet.py` function in [py/aSPU_py](https://github.com/ikwak2/aSPU_py) do the same job with 
```{py}
#./MTaSPUsSet.py ZsF.txt corPheF.txt corSNPF.txt 100 outF.txt
```
...
Now, let's try it to GIANT Man data. 
```{r outMPZ}
