...
Investigation of ANthropometric Traits (GIANT) consortium data. We mapped SNPs and Phenotypes related to gene `SAMD11`,  and we saved it as `SAMD11` Rdata file in aSPU package for example.
