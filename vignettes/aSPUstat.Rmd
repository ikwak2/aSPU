...
for( g in kegg9$gene.info[,1]) {
    snps <-
    which( ( kegg9$snp.info2[,2] == kegg9$gene.info[kegg9$gene.info[,1]==g,2]) &
           (kegg9$snp.info2[,3] > kegg9$gene.info[kegg9$gene.info[,1] == g, 3])&
           (kegg9$snp.info2[,3] < kegg9$gene.info[kegg9$gene.info[,1] == g, 4]))
